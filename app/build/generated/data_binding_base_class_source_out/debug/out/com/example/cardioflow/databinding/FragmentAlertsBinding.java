...
public final class FragmentAlertsBinding implements ViewBinding {
  ...
  private FragmentAlertsBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView recyclerView) {
  ...
  public static FragmentAlertsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAlertsBinding((FrameLayout) rootView, recyclerView);
    }
