...
public class DataManager {
    ...
    private void loadData() {
        try {
            InputStream is = context.getAssets().open("patients_data.json");
    ...
    public Thresholds getThresholdsForPatient(String patientId) {
        ...
        defaultThresholds.setHrMin(50);
        defaultThresholds.setHrMax(100);
        defaultThresholds.setSpo2Min(90);
        defaultThresholds.setTempMin(35.5);
        defaultThresholds.setTempMax(37.5);
        defaultThresholds.setHumMin(30);
        defaultThresholds.setHumMax(70);
        defaultThresholds.setPersistSeconds(10);
        defaultThresholds.setActivityIntervalMinutes(5);
